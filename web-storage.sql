...
select * from users;
insert into users values('admin', 'tnc87409123@', 'Í¥?Î¶¨Ïûê', 'm', '01075524110', 'tncrja@naver.com', '05707', '?Ñú?ö∏ ?Ü°?ååÍµ? ?Ü°?ù¥Î°? 88(Í∞??ùΩ??Î¶ºÏïÑ?åå?ä∏) 1?èô');
...
select * from qna;
insert into qna values(seq_qna_id.nextval, 'admin', '?Öå?ä§?ä∏?ö©', '?Öå?ä§?ä∏Î•? ?úÑ?ïú Í≤åÏãúÎ¨? ?ûÖ?ãà?ã§.', 10, '192.168.0.25', sysdate);
